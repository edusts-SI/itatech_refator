...
const MockupG2PSI = () => (
  <div className="w-full h-full bg-[#1c1c1c] text-white flex flex-col p-4 font-sans">
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-gray-300 text-[10px] px-2 leading-relaxed pb-4">
        Aqui você encontrará uma variedade de projetos inovadores que abrangem diversas áreas. Nossos estudantes e professores estão sempre em busca de novas soluções e aprimoramento tecnológico.
      </p>
    </div>
  </div>
);
    ...
    <div className="w-full bg-[#e8eaed] rounded-xl border border-red-500/30 p-5 shadow-lg relative overflow-hidden">
      ...
      <div className="flex justify-center mb-6 mt-2">
        <div className="w-24 h-24 rounded-full bg-black flex flex-col items-center justify-center text-white border-2 border-red-600 relative">
          <span className="text-[8px] font-bold tracking-widest mt-2 uppercase">Batalá</span>
  ...
  <div className="w-full h-full bg-white flex flex-col overflow-hidden relative">
    <div className="bg-[#3e2723] px-4 py-2 flex justify-between items-center text-white text-[10px]">
      <div className="flex items-center gap-2 opacity-80">
        <span className="text-[8px]">guardioesdospolinizadores.com.br</span>
      </div>
